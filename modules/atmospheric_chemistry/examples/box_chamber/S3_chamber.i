# F0AM Chamber Example — S3 (NO₂ = 10 ppb)
# High-NOx isoprene + NOx + H2O2 chamber oxidation
...
[ICs]
  ...
  [NO2_ic]     type = ScalarConstantIC  variable = NO2   value = 2.47e11   []  # 10 ppb (S3)

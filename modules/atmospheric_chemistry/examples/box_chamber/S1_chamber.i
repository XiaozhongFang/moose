# F0AM Chamber Example — S1 (NO₂ = 0.1 ppb)
# Low-NOx isoprene + NOx + H2O2 chamber oxidation
...
[ICs]
  ...
  [NO2_ic]     type = ScalarConstantIC  variable = NO2   value = 2.47e9    []  # 0.1 ppb (S1)

# Chamber S1 with PETSc TS(ARKIMEX), relaxed tolerance for performance sweep
[Mesh]
  [gen]
...
[AtmosphericChemistry]
  ...
  jfac = 1.0
  box_solver = true
  box_solver_type = arkimex
  box_solver_rtol = 1e-2
  box_solver_atol = 1e-6
[]
...
[Outputs]
  ...
  file_base = 'vs_F0AM_chamber_S1_box_ts_arkimex_rtol1e-2'

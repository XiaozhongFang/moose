...
# Fully-coupled: NavierStokesFV Action + AtmosphericChemistry Action
# Chemistry species (A,B,C,ONE,RO2) are advected by NS velocity field
#
# Requires: combined-opt
# If non-convergent: reduce nx/ny or use --pc_type lu
...
[Kernels]
  # Species advection (NS velocity carries chemistry species)

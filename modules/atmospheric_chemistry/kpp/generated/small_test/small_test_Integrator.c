...
/*~~~> Function headers */
 ...
 void Rodas3 ( int *ros_S, double ros_A[], double ros_C[],
	     ...
	     double ros_Alpha[], double ros_Gamma[],
	     char ros_NewF[], double *ros_ELO, char* ros_Name );
 void Rodas3_1 ( int *ros_S, double ros_A[], double ros_C[],
             double ros_M[], double ros_E[],
	     double ros_Alpha[], double ros_Gamma[],
	     char ros_NewF[], double *ros_ELO, char* ros_Name );
  ...
  /*~~~>   Initialize the particular Rosenbrock method */
   switch (Method) {
     ...
     case 5:
       ...
       break;
     case 7:
       Rodas3_1(&ros_S, ros_A, ros_C, ros_M, ros_E,
         ros_Alpha, ros_Gamma, ros_NewF, &ros_ELO, ros_Name);
       break;
     default:
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   double Ynew[5], Fcn0[5], Fcn[5],
      dFdT[5],
      Jac0[19], Ghimj[19];
   double K[5*ros_S];
   double H, T, Hnew, HC, HG, Fac, Tau;
   double Err, Yerr[5];
   int Pivot[5], Direction, ioffset, j, istage;
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
  ...
  /*~~~>   Compute the stages  */
   for (istage = 1; istage <= ros_S; istage++) {
      ...
      /* Current istage offset. Current istage vector is K[ioffset:ioffset+5-1] */
      ioffset = 5*(istage-1);

      /* For the 1st istage the function has been computed previously */
      if ( istage == 1 )
	   WCOPY(5,Fcn0,1,Fcn,1);
      else { /* istage>1 and a new function evaluation is needed at current istage */
	if ( ros_NewF[istage-1] ) {
	   WCOPY(5,Y,1,Ynew,1);
	   for (j = 1; j <= istage-1; j++)
	     WAXPY(5,ros_A[(istage-1)*(istage-2)/2+j-1],
                   &K[5*(j-1)],1,Ynew,1);
  ...
  /*~~~>  Compute the new solution   */
   WCOPY(5,Y,1,Ynew,1);
   for (j=1; j<=ros_S; j++)
       WAXPY(5,ros_M[j-1],&K[5*(j-1)],1,Ynew,1);

  /*~~~>  Compute the error estimation   */
   WSCAL(5,ZERO,Yerr,1);
   for (j=1; j<=ros_S; j++)
       WAXPY(5,ros_E[j-1],&K[5*(j-1)],1,Yerr,1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
  ...
  /*~~~>    Construct Ghimj = 1/(H*ham) - Jac0 */
     WCOPY(19,Jac0,1,Ghimj,1);
     WSCAL(19,(-ONE),Ghimj,1);
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
  ...
  /*~~~> The coefficient matrices A and C are strictly lower triangular.
    ...
    The general mapping formula is:
        A_{i,j} = ros_A[ (i-1)*(i-2)/2 + j -1 ]  */
   ros_A[0] = (double)0.000000000000000;
   ros_A[1] = (double)0.646601929740551;
   ros_A[2] = (double)0.409567801987914;
   ros_A[3] = (double)0.646601929740551;
   ros_A[4] = (double)0.409567801987914;
   ros_A[5] = (double)1.000000000000000;

  /*~~~>     C_{i,j} = ros_C[ (i-1)*(i-2)/2 + j -1]  */
   ros_C[0] = (double)4.198495621784201;
   ros_C[1] = (double)3.711590161613010;
   ros_C[2] = (double)(-1.787771994729384);
   ros_C[3] = (double)4.458898153216104;
   ros_C[4] = (double)(-2.024095448516552);
   ros_C[5] = (double)(-2.626700600119396);
  ...
  /*~~~> M_i = Coefficients for new step solution */
   ros_M[0] = (double)0.646601929740551;
   ros_M[1] = (double)0.409567801987914;
   ros_M[2] = (double)1.000000000000000;
   ros_M[3] = (double)1.000000000000000;

  /*~~~> E_i  = Coefficients for error estimator */
   ros_E[0] = (double)0.000000000000000;
   ros_E[1] = (double)0.000000000000000;
   ros_E[2] = (double)0.000000000000000;
   ros_E[3] = (double)1.000000000000000;

  /*~~~> ros_ELO  = estimator of local order - the minimum between the
!    main and the embedded scheme orders plus 1 */
   *ros_ELO  = (double)3.0000000000000000;

  /*~~~> Y_stage_i ~ Y( T + H*Alpha_i ) */
   ros_Alpha[0] = (double)0.000000000000000;
   ros_Alpha[1] = (double)0.000000000000000;
   ros_Alpha[2] = (double)1.000000000000000;
   ros_Alpha[3] = (double)1.000000000000000;

  /*~~~> Gamma_i = \sum_j  gamma_{i,j}  */
   ros_Gamma[0] = (double)0.515000000000000;
   ros_Gamma[1] = (double)1.628546001287715;
   ros_Gamma[2] = (double)0.000000000000000;
   ros_Gamma[3] = (double)0.000000000000000;
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
  ...
  /*~~~> Note: for a full matrix use Lapack:
      NRHS = 1
      DGETRS( 'N', 5 , NRHS, A, 5, Pivot, b, 5, INFO ) */
